...
@section('content-dinamis')
    <div class="container mt-5" style="width: 80%; max-width: 1200px;">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{route('orders.create')}}" class="btn btn-primary">+tambah Pembelian</a>
        </div>
        </div>
        <div class="mt-4">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    @else
                    <tr>
                        <td colspan="7" class="font-wight-bold text-danger text-center">Data Order Pengguna Kosong</td>
                    </tr>
                    @endif
                </tbody>
            </table>
